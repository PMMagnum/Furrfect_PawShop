...
<body>
    <header>
        <div class="container" style="position: relative; overflow: hidden; min-height: 180px;">
            <img src="images/your cart.jpg" alt="Your Cart" style="
                position: absolute;
        ...
        ">
                <h2 style="font-size: 2rem; color: #6A4E3C;">Your Cart</h2>
                <a href="main.php" style="color:rgba(192, 100, 8, 0.78); font-weight: bold;">Continue Shopping</a>
            </div>
        </div>
    </header>
